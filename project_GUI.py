...
notebook_A.grid_rowconfigure(index=0, weight=1)
notebook_A.grid_rowconfigure(index=1, weight=1, minsize=200)
notebook_A.grid_columnconfigure(index=0, weight=1)
notebook_A.grid_columnconfigure(index=1, weight=0, minsize=200)

frame_A = ttk.Frame(notebook_A, relief='flat')
frame_A.grid_rowconfigure(index=0, weight=1)
frame_B = ttk.Frame(notebook_A, relief='flat')
frame_C = ttk.Frame(notebook_A, relief='flat')
frame_D = ttk.Frame(notebook_A, relief='flat')
...
frame_A_subframe_A = ttk.LabelFrame(frame_A, text='label frame', relief='flat')
frame_A_subframe_A.grid(row=0, column=0, sticky='nwse')

frame_A_subframe_A.grid_rowconfigure(index=0, weight=1)
frame_A_subframe_A.grid_rowconfigure(index=1, weight=1)
# frame_A_subframe_A.grid_columnconfigure(index=0, weight=2)
# frame_A_subframe_A.grid_columnconfigure(index=1, weight=1)
...
# button_A = ttk.Button(window, text='Button 1')

# input_A = ttk.Entry(window,text='Input 1')

# dropdown_A = ttk.Combobox(window,text='Dropdown 1')

# checkbox_A = ttk.Checkbutton(window, text='Checkbox 1')

# spinbox_A = ttk.Spinbox(window, text='Spinbox 1')

# heading_A = ttk.Frame(window, width=50)
